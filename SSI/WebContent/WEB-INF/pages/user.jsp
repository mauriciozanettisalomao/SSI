			...
			<form action="${pageContext.request.contextPath}/novaSolicitacao"
				...
				<div>
					<div class="row">
						...
						<input type="hidden" name="cdLoginUser"
							value="${user.cdLoginUser}" />
						<div class="col-xs-6">${user.cdLoginUser}</div>
						<div class="col-xs-2 FundoTitulo textdefaultbold">
							<c:choose>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-3 FundoTitulo textdefaultbold">Centro
							de Custo/Área</div>
