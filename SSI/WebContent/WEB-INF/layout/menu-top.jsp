				...
				<div class="container-fluid">
					<div class="navbar-header">
						<button type="button" class="navbar-toggle" data-toggle="collapse"
							data-target="#elementoCollapse1">
							<span class="icon-bar"></span> <span class="icon-bar"></span> <span
								class="icon-bar"></span>
						</button>
						<span class="navbar-brand visible-xs-block">SSI</span>						
					</div>
				</div>
				<div class="collapse navbar-collapse nav-collapse-auto-height" id="elementoCollapse1">
					...
					<c:if test="${group ne row.descriptionGroup}">
						...
						<li class="dropdown" role="menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown">${row.descriptionGroup}
